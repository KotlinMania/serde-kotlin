...
interface Deserializer {
     ...
     */
    fun <V> deserializeI128(visitor: Visitor<V>): SerdeResult<V> = SerdeResult.failure(Error.custom("i128 is not supported"))
     ...
     * The default behavior unconditionally returns an error.
     */
    fun <V> deserializeU128(visitor: Visitor<V>): SerdeResult<V> = SerdeResult.failure(Error.custom("u128 is not supported"))
