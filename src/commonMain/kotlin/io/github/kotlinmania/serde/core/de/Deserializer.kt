...
interface Deserializer {
     ...
     */
    fun <V> deserializeI128(visitor: Visitor<V>): Result<V> {
     ...
     */
    fun <V> deserializeU8(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a `UShort` value.
     */
    fun <V> deserializeU16(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a `UInt` value.
     */
    fun <V> deserializeU32(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a `ULong` value.
     */
    fun <V> deserializeU64(visitor: Visitor<V>): Result<V>
     ...
     * The default behavior unconditionally returns an error.
     */
    fun <V> deserializeU128(visitor: Visitor<V>): Result<V> {
     ...
     */
    fun <V> deserializeF32(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a `Double` value.
     */
    fun <V> deserializeF64(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a `Char` value.
     */
    fun <V> deserializeChar(visitor: Visitor<V>): Result<V>
     ...
     */
    fun <V> deserializeStr(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a string value and would benefit from taking
     * ownership of buffered data owned by the `Deserializer`.
     */
    fun <V> deserializeString(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a byte array and does not benefit from taking
     * ownership of buffered data owned by the `Deserializer`.
     */
    fun <V> deserializeBytes(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a byte array and would benefit from taking
     * ownership of buffered data owned by the `Deserializer`.
     */
    fun <V> deserializeByteBuf(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting an optional value.
     */
    fun <V> deserializeOption(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type is expecting a unit value.
     */
    fun <V> deserializeUnit(visitor: Visitor<V>): Result<V>
     ...
     */
    fun <V> deserializeSeq(visitor: Visitor<V>): Result<V>
     ...
     */
    fun <V> deserializeMap(visitor: Visitor<V>): Result<V>
     ...
     * of an enum variant.
     */
    fun <V> deserializeIdentifier(visitor: Visitor<V>): Result<V>

    /**
     * Hint that the `Deserialize` type needs to deserialize a value whose type doesn't matter
     * because it is ignored.
     */
    fun <V> deserializeIgnoredAny(visitor: Visitor<V>): Result<V>
