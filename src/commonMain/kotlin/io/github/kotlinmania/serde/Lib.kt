// port-lint: source serde/src/lib.rs
 ...
 * themselves along with data formats that know how to serialize and deserialize other things.
 * Serde provides the layer by which these two groups interact with each other, allowing any
 * supported data structure to be serialized and deserialized using any supported data format.
 *
 ...
 * ## Data formats
 *
 * The following is a partial list of data formats that have been implemented for Serde by the
 * community.
 *
 * - [JSON], the ubiquitous JavaScript Object Notation used by many HTTP APIs.
 * - [Postcard], a no_std and embedded-systems friendly compact binary format.
 * - [CBOR], a Concise Binary Object Representation designed for small message size without the
