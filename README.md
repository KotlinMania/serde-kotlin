...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:serde-kotlin:0.1.11")
}
```

The modules are published as separate Maven coordinates: `serde-kotlin:0.1.11`,
`serde-core:0.1.11`, and `serde-derive:0.1.11`. Most consumers only need
