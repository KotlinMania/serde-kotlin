...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:serde-kotlin:0.1.8")
}
```

The modules are published as separate Maven coordinates: `serde-kotlin:0.1.8`,
`serde-core:0.1.8`, and `serde-derive:0.1.8`. Most consumers only need
