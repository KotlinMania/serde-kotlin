// port-lint: tests test_suite/tests/test_borrow.rs
package io.github.kotlinmania.serderive

import kotlin.test.Test

class TestBorrowJvmTest {
    @Test
    fun testBorrowedStr() = runBorrowRustTest("test_borrowed_str")

    @Test
    fun testBorrowedStrFromString() = runBorrowRustTest("test_borrowed_str_from_string")

    @Test
    fun testBorrowedStrFromStr() = runBorrowRustTest("test_borrowed_str_from_str")

    @Test
    fun testStringFromBorrowedStr() = runBorrowRustTest("test_string_from_borrowed_str")

    @Test
    fun testBorrowedBytes() = runBorrowRustTest("test_borrowed_bytes")

    @Test
    fun testBorrowedBytesFromBytebuf() = runBorrowRustTest("test_borrowed_bytes_from_bytebuf")

    @Test
    fun testBorrowedBytesFromBytes() = runBorrowRustTest("test_borrowed_bytes_from_bytes")

    @Test
    fun testTuple() = runBorrowRustTest("test_tuple")

    @Test
    fun testStruct() = runBorrowRustTest("test_struct")

    @Test
    fun testFieldIdentifier() = runBorrowRustTest("test_field_identifier")

    @Test
    fun testCow() = runBorrowRustTest("test_cow")

    @Test
    fun testLifetimes() = runBorrowRustTest("test_lifetimes")
}

private val borrowFixtureSource by lazy(::buildBorrowFixtureSource)

private fun runBorrowRustTest(testName: String) {
    runExactSerdeRustTest(
        fixtureName = "test_borrow",
        source = borrowFixtureSource,
        testName = testName,
    )
}

private fun buildBorrowFixtureSource(): String {
    val generated =
    ...
    require(generated.serdeDerivedItems == 6) {
        "Expected 6 serde-derived declarations, transformed ${generated.serdeDerivedItems}"
    }
