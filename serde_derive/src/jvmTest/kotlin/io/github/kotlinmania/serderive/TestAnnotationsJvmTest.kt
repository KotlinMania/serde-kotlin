// port-lint: tests test_suite/tests/test_annotations.rs
package io.github.kotlinmania.serderive

import kotlin.test.Test

class TestAnnotationsJvmTest {
    @Test
    fun testDefaultStruct() = runAnnotationsRustTest("test_default_struct")

    @Test
    fun testDefaultTuple() = runAnnotationsRustTest("test_default_tuple")

    @Test
    fun testDefaultStructVariant() = runAnnotationsRustTest("test_default_struct_variant")

    @Test
    fun testDefaultTupleVariant() = runAnnotationsRustTest("test_default_tuple_variant")

    @Test
    fun testNoStdDefault() = runAnnotationsRustTest("test_no_std_default")

    @Test
    fun testEltNotDeserialize() = runAnnotationsRustTest("test_elt_not_deserialize")

    @Test
    fun testIgnoreUnknown() = runAnnotationsRustTest("test_ignore_unknown")

    @Test
    fun testRenameStruct() = runAnnotationsRustTest("test_rename_struct")

    @Test
    fun testUnknownFieldRenameStruct() = runAnnotationsRustTest("test_unknown_field_rename_struct")

    @Test
    fun testRenameEnum() = runAnnotationsRustTest("test_rename_enum")

    @Test
    fun testUnknownFieldRenameEnum() = runAnnotationsRustTest("test_unknown_field_rename_enum")

    @Test
    fun testSkipSerializingStruct() = runAnnotationsRustTest("test_skip_serializing_struct")

    @Test
    fun testSkipSerializingTupleStruct() = runAnnotationsRustTest("test_skip_serializing_tuple_struct")

    @Test
    fun testSkipStruct() = runAnnotationsRustTest("test_skip_struct")

    @Test
    fun testSkipSerializingEnum() = runAnnotationsRustTest("test_skip_serializing_enum")

    @Test
    fun testEltNotSerialize() = runAnnotationsRustTest("test_elt_not_serialize")

    @Test
    fun testSerializeWithStruct() = runAnnotationsRustTest("test_serialize_with_struct")

    @Test
    fun testSerializeWithEnum() = runAnnotationsRustTest("test_serialize_with_enum")

    @Test
    fun testSerializeWithVariant() = runAnnotationsRustTest("test_serialize_with_variant")

    @Test
    fun testDeserializeWithVariant() = runAnnotationsRustTest("test_deserialize_with_variant")

    @Test
    fun testDeserializeWithStruct() = runAnnotationsRustTest("test_deserialize_with_struct")

    @Test
    fun testDeserializeWithEnum() = runAnnotationsRustTest("test_deserialize_with_enum")

    @Test
    fun testMissingRenamedFieldStruct() = runAnnotationsRustTest("test_missing_renamed_field_struct")

    @Test
    fun testMissingRenamedFieldEnum() = runAnnotationsRustTest("test_missing_renamed_field_enum")

    @Test
    fun testInvalidLengthEnum() = runAnnotationsRustTest("test_invalid_length_enum")

    @Test
    fun testFromIntoTraits() = runAnnotationsRustTest("test_from_into_traits")

    @Test
    fun testCollectOther() = runAnnotationsRustTest("test_collect_other")

    @Test
    fun testPartiallyUntaggedEnum() = runAnnotationsRustTest("test_partially_untagged_enum")

    @Test
    fun testPartiallyUntaggedEnumGeneric() = runAnnotationsRustTest("test_partially_untagged_enum_generic")

    @Test
    fun testPartiallyUntaggedEnumDesugared() = runAnnotationsRustTest("test_partially_untagged_enum_desugared")

    @Test
    fun testPartiallyUntaggedInternallyTaggedEnum() = runAnnotationsRustTest("test_partially_untagged_internally_tagged_enum")

    @Test
    fun testTransparentStruct() = runAnnotationsRustTest("test_transparent_struct")

    @Test
    fun testTransparentTupleStruct() = runAnnotationsRustTest("test_transparent_tuple_struct")

    @Test
    fun testExpectingMessage() = runAnnotationsRustTest("test_expecting_message")

    @Test
    fun testExpectingMessageExternallyTaggedEnum() = runAnnotationsRustTest("test_expecting_message_externally_tagged_enum")

    @Test
    fun testExpectingMessageIdentifierEnum() = runAnnotationsRustTest("test_expecting_message_identifier_enum")

    @Test
    fun flattenComplex() = runAnnotationsRustTest("flatten::complex")

    @Test
    fun flattenMapTwice() = runAnnotationsRustTest("flatten::map_twice")

    @Test
    fun flattenUnsupportedType() = runAnnotationsRustTest("flatten::unsupported_type")

    @Test
    fun flattenUnknownField() = runAnnotationsRustTest("flatten::unknown_field")

    @Test
    fun flattenNonStringKeys() = runAnnotationsRustTest("flatten::non_string_keys")

    @Test
    fun flattenLifetimePropagation() = runAnnotationsRustTest("flatten::lifetime_propagation")

    @Test
    fun flattenEnumTupleAndStruct() = runAnnotationsRustTest("flatten::enum_tuple_and_struct")

    @Test
    fun flattenOption() = runAnnotationsRustTest("flatten::option")

    @Test
    fun flattenIgnoredAny() = runAnnotationsRustTest("flatten::ignored_any")

    @Test
    fun flattenAnyAfterFlattenStruct() = runAnnotationsRustTest("flatten::flatten_any_after_flatten_struct")

    @Test
    fun flattenAlias() = runAnnotationsRustTest("flatten::alias")

    @Test
    fun flattenUnitUnit() = runAnnotationsRustTest("flatten::unit::unit")

    @Test
    fun flattenUnitUnitStruct() = runAnnotationsRustTest("flatten::unit::unit_struct")

    @Test
    fun flattenExternallyTaggedStraightforward() = runAnnotationsRustTest("flatten::enum_::externally_tagged::straightforward")

    @Test
    fun flattenExternallyTaggedUnit() = runAnnotationsRustTest("flatten::enum_::externally_tagged::unit")

    @Test
    fun flattenExternallyTaggedNewtype() = runAnnotationsRustTest("flatten::enum_::externally_tagged::newtype")

    @Test
    fun flattenExternallyTaggedTuple() = runAnnotationsRustTest("flatten::enum_::externally_tagged::tuple")

    @Test
    fun flattenExternallyTaggedStructFromSeq() = runAnnotationsRustTest("flatten::enum_::externally_tagged::struct_from_seq")

    @Test
    fun flattenExternallyTaggedStructFromMap() = runAnnotationsRustTest("flatten::enum_::externally_tagged::struct_from_map")

    @Test
    fun flattenAdjacentlyTaggedUnit() = runAnnotationsRustTest("flatten::enum_::adjacently_tagged::unit")

    @Test
    fun flattenAdjacentlyTaggedNewtype() = runAnnotationsRustTest("flatten::enum_::adjacently_tagged::newtype")

    @Test
    fun flattenAdjacentlyTaggedStruct() = runAnnotationsRustTest("flatten::enum_::adjacently_tagged::struct_")

    @Test
    fun flattenInternallyTaggedStructs() = runAnnotationsRustTest("flatten::enum_::internally_tagged::structs")

    @Test
    fun flattenInternallyTaggedUnitEnumWithUnknownFields() = runAnnotationsRustTest("flatten::enum_::internally_tagged::unit_enum_with_unknown_fields")

    @Test
    fun flattenUntaggedStruct() = runAnnotationsRustTest("flatten::enum_::untagged::struct_")
}

private val annotationsFixtureSource by lazy(::buildAnnotationsFixtureSource)

private fun runAnnotationsRustTest(testName: String) {
    runExactSerdeRustTest(
        fixtureName = "test_annotations",
        source = annotationsFixtureSource,
        testName = testName,
    )
}

private fun buildAnnotationsFixtureSource(): String {
    val generated =
                        ...
                        D: Deserializer<'de>,
                    {
                        ...
                        impl<'de> Visitor<'de> for AnyVisitor {
                            ...
                            fn expecting(&self, _formatter: &mut fmt::Formatter) -> fmt::Result {
                                _formatter.write_str("any value")
                            }
    ...
    require(generated.serdeDerivedItems == 84) {
        "Expected 84 serde-derived declarations, transformed ${generated.serdeDerivedItems}"
    }
