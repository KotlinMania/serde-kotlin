...
import io.github.kotlinmania.serderive.de.{deserialize_seq, has_flatten, Parameters, TupleForm}
...
pub(super) fun deserialize(
    ...
    quote_block! {
        ...
        impl #de_impl_generics _serde.de.Visitor<#delife> for __Visitor #de_ty_generics #where_clause {
            ...
            `#`[inline]
            fun visit_seq<__A>(self, #visitor_var: __A) -> _serde.#private.Result<Self.Value, __A.Error>
            where
...
fun deserialize_newtype_struct(
    ...
    quote {
        `#`[inline]
        fun visit_newtype_struct<__E>(self, #deserializer_var: __E) -> _serde.#private.Result<Self.Value, __E.Error>
        where
...
pub(super) fun deserialize_in_place(
    ...
    val visit_newtype_struct = if nfields == 1 {
        ...
        Some(quote {
            `#`[inline]
            fun visit_newtype_struct<__E>(self, __e: __E) -> _serde.#private.Result<Self.Value, __E.Error>
            where
                __E: _serde.Deserializer<#delife>,
            {
