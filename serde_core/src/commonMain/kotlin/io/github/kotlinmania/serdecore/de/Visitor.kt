...
interface Visitor<Value> : Expected {
     ...
     */
    fun visitBool(v: Boolean): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Bool(v), this))
     ...
     */
    fun visitI64(v: Long): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Signed(v), this))

    /**
     * The input contains an `i128`.
     */
    fun visitI128(v: String): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Other("integer `$v` as i128"), this))
     ...
     */
    fun visitU64(v: ULong): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Unsigned(v), this))

    /**
     * The input contains a `u128`.
     */
    fun visitU128(v: String): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Other("integer `$v` as u128"), this))
     ...
     */
    fun visitF64(v: Double): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.FloatValue(v), this))
     ...
     */
    fun visitStr(v: String): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Str(v), this))
     ...
     */
    fun visitBytes(v: ByteArray): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Bytes(v), this))
     ...
     */
    fun visitNone(): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.Option, this))
    ...
    fun <D> visitSome(deserializer: D): SerdeResult<Value>
        ...
        SerdeResult.failure(SerdeError.invalidType(Unexpected.Option, this))

    /**
     * The input contains a unit `Unit`.
     */
    fun visitUnit(): SerdeResult<Value> = SerdeResult.failure(SerdeError.invalidType(Unexpected.UnitValue, this))
    ...
    fun <D> visitNewtypeStruct(deserializer: D): SerdeResult<Value>
        where D : Deserializer =
        SerdeResult.failure(SerdeError.invalidType(Unexpected.NewtypeStruct, this))
    ...
    fun <A> visitSeq(access: A): SerdeResult<Value>
        where A : SeqAccess =
        SerdeResult.failure(SerdeError.invalidType(Unexpected.Seq, this))
    ...
    fun <A> visitMap(access: A): SerdeResult<Value>
        where A : MapAccess =
        SerdeResult.failure(SerdeError.invalidType(Unexpected.Map, this))
    ...
    fun <A> visitEnum(access: A): SerdeResult<Value>
        where A : EnumAccess =
        SerdeResult.failure(SerdeError.invalidType(Unexpected.Enum, this))
