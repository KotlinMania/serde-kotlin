...
Clean-room Kotlin Multiplatform port of the upstream Rust crate [`serde`](https://crates.io/crates/serde). Every Kotlin file is a faithful translation of one Rust file. No JVM-only deps, no Java imports, no shortcuts via established Java/Kotlin libraries.
