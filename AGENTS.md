# Agent guide - serde-kotlin

This file is the quick-reference operating contract for serde-kotlin. The longer
...
serde-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serde`](https://crates.io/crates/serde). Upstream Rust is the behavioral oracle while the
...
- Automation note: Work until you are blocked or reach a limit.
