...
private data object I128Visitor : Visitor<String> {
    ...
    override fun visitI128(v: String): Result<String> = Result.success(v)

    override fun visitI8(v: Byte): Result<String> = Result.success(v.toLong().toString())

    override fun visitI16(v: Short): Result<String> = Result.success(v.toLong().toString())

    override fun visitI32(v: Int): Result<String> = Result.success(v.toLong().toString())

    override fun visitI64(v: Long): Result<String> = Result.success(v.toString())

    override fun visitU8(v: UByte): Result<String> = Result.success(v.toULong().toString())

    override fun visitU16(v: UShort): Result<String> = Result.success(v.toULong().toString())

    override fun visitU32(v: UInt): Result<String> = Result.success(v.toULong().toString())

    override fun visitU64(v: ULong): Result<String> = Result.success(v.toString())

    override fun visitU128(v: String): Result<String> =
        if (compareUnsignedDecimal(v, I128_MAX_AS_U128) <= 0) Result.success(v) else invalidOther("u128", this)
}
...
private data object U128Visitor : Visitor<String> {
    ...
    override fun visitU128(v: String): Result<String> = Result.success(v)
