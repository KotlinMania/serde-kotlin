    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:syn-kotlin:0.1.5")
            }
        }
...
dependencies {
    ...
    codeqlAndroidAar("io.github.kotlinmania:syn-kotlin-android:0.1.5")
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSerdeDebugXCFramework",
    "assembleSerdeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSerdeXCFramework",
    "assembleReleaseIosFatFrameworkForSerdeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSerdeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSerdeXCFramework",
    "assembleDebugMacosFatFrameworkForSerdeXCFramework",
    "assembleReleaseMacosFatFrameworkForSerdeXCFramework",
    "assembleDebugTvosFatFrameworkForSerdeXCFramework",
    "assembleReleaseTvosFatFrameworkForSerdeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSerdeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSerdeXCFramework",
    "assembleDebugWatchosFatFrameworkForSerdeXCFramework",
    "assembleReleaseWatchosFatFrameworkForSerdeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSerdeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSerdeXCFramework",
